...
extension TweakAccessorCodeGenerator {
    ...
    func generateAccessorFileContent(tweaksFilename: String,
        ...
        let classContent = self.classContent(with: tweaks, accessorClassName: accessorClassName)
    ...
    private func classContent(with tweaks: [Tweak], accessorClassName: String) -> String {
